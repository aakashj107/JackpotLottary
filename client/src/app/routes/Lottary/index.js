...
const Lottary = () => {
  ...
  return (
    <div className="container-fluid bg-overlay bg_img container_background inner-item" style={{ backgroundImage: "../../assets/images/inner-bg01.jpg" }}>
      <div className="inner-inner">
        ...
        <Buttons columnXYObj={columnXYObj} columnObj={columnObj} onClickBuy={onClickBuy} />
      </div>
    </div>
  );
};
